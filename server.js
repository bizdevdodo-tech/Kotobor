...
async function markEnergyExhausted(
  userId,
  resetsAt,
  db = pool
) {
...
async function processEnergyRestores() {
  try {
    const result =
      await pool.query(
        `
...
Снова можно голосовать в КОТОБОРЕ. 🐈⚔️`
      );
